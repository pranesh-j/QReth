#before getting started please run:  pip install qr[pil] in the cmd/shell, otherwise you wont see the QR code
...
#Now To generate the QR code specific to Ethereum wallet address
